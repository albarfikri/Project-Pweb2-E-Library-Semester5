...
<div id="con2">
            ...
            <form action="editaksi.jsp" method="post">
                ...
                %>   
                <p>
                    <label></label><input type="hidden" name="id_penerbit" value='<%=rs.getString("id_penerbit")%>'/>
                </p>
                <p>
                    <label>Nama</label><input type="text" name="nama_penerbit" value='<%=rs.getString("nama_penerbit")%>'/>
                </p>
