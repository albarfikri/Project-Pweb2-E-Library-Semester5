<%-- 
    Document   : edit
    Created on : Nov 25, 2016, 4:20:29 PM
    Author     : Iqbal
    Correct by : Danboru
--%>
...
<div id="con2">
            ...
            <form action="editaksi.jsp" method="post">
                ...
                %>   
                <p>
                    <label></label><input type="hidden" name="id_pengarang" value='<%=rs.getString("id_pengarang")%>'/>
                </p>
                <p>
                    <label>Nama</label><input type="text" name="nama_pengarang" value='<%=rs.getString("nama_pengarang")%>'/>
                </p>
                
                <p>
                    <label></label><input type="submit" name="submit" value="Update"/>
                    <a href="pengarang.jsp">Kembali</a>
                </p>
                <%   }
                    rs.close();
                    statement.close();
