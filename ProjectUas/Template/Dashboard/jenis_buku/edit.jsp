...
<div id="con2">
            ...
            <form action="editaksi.jsp" method="post">
                ...
                %>   
                <p>
                    <label></label><input type="hidden" name="id_penerbit" value='<%=rs.getString("id_jenis_buku")%>'/>
                </p>
                <p>
                    <label>Nama</label><input type="text" name="nama_penerbit" value='<%=rs.getString("jenis_buku")%>'/>
                </p>
                
                <p>
                    <label></label><input type="submit" name="submit" value="Update"/>
                    <a href="jenis_buku.jsp">Kembali</a>
                </p>
                <%   }
                    rs.close();
                    statement.close();
