    ...
    <body>
       <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                <li class="active"><a href="${pageContext.request.contextPath}/index/indexlog.jsp"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Dashboard</a></li>
                ...
                <li class="parent ">
                    ...
                    <ul class="children collapse" id="sub-item-1">
                        <li>
                            <a class="" href="${pageContext.request.contextPath}/pengarang/pengarang.jsp">
                                <svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Pengarang
                            </a>
                        </li>
                        <li>
                            <a class="" href="${pageContext.request.contextPath}/penerbit/penerbit.jsp">
                                <svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Penerbit
                            </a>
                        </li>
                        <li>
                            <a class="" href="${pageContext.request.contextPath}/jenis_buku/jenis_buku.jsp">
                                <svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Jenis Buku
                            </a>
                        </li>
                    </ul>
                </li>
        ...
        <script src="http://localhost:8080/assets/js/jquery-1.11.1.min.js"></script>
        <script src="http://localhost:8080/assets/js/bootstrap.min.js"></script>
        <script src="http://localhost:8080/assets/js/chart.min.js"></script>
        <script src="http://localhost:8080/assets/js/chart-data.js"></script>
        <script src="http://localhost:8080/assets/js/easypiechart.js"></script>
        <script src="http://localhost:8080/assets/js/easypiechart-data.js"></script>
        <script src="http://localhost:8080/assets/js/bootstrap-datepicker.js"></script>
        <script>
            $('#calendar').datepicker({
            });
