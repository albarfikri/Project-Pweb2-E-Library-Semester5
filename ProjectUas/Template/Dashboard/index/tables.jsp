    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/index/tables.jsp"><svg class="glyph stroked male user"><use xlink:href="#stroked-male-user"></use></svg> Anggota</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            ...
            <%
                ArrayList<pegawai> list = pegawaidatabase.selectAll();
            %>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <button onclick="window.location.href = 'TambahPetugas.jsp';" class="btn btn-info btn-rounded" data-target="cari">
                            ...
                            <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                                ...
                                <tr>
                                    <td><%=i + 1%></td>
                                    <td><%= list.get(i).getIdPetugas()%></td>
                                    <td><%= list.get(i).getUsername()%></td>
                                    <td><%= list.get(i).getPassword()%></td>
                                    <td><%= list.get(i).getPeran()%></td>
                                    <td><%= list.get(i).getNama()%></td>
                                    <td><%= list.get(i).getAlamat()%></td>
                                    <td><%= list.get(i).getNo()%></td>
                                    <td>
                                        <button onclick="window.location.href = 'formEditPegawai.jsp?id=<%= list.get(i).getIdPetugas()%>';" type="button" class="btn btn-primary">
                                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                        </button>
                                        <button onclick="window.location.href = 'OlahHapusPegawai.jsp?id=<%= list.get(i).getIdPetugas()%>';" type="button" class="btn btn-danger">
        ...
        <script src="http://localhost:8080/Perpustakaan-master/assets/js/jquery-1.11.1.min.js"></script>
        <script src="http://localhost:8080/Perpustakaan-master/assets/js/bootstrap.min.js"></script>
        <script src="http://localhost:8080/Perpustakaan-master/assets/js/chart.min.js"></script>
        <script src="http://localhost:8080/Perpustakaan-master/assets/js/chart-data.js"></script>
        <script src="http://localhost:8080/Perpustakaan-master/assets/js/easypiechart.js"></script>
        <script src="http://localhost:8080/Perpustakaan-master/assets/js/easypiechart-data.js"></script>
        <script src="http://localhost:8080/Perpustakaan-master/assets/js/bootstrap-datepicker.js"></script>
        <script src="http://localhost:8080/Perpustakaan-master/assets/js/bootstrap-table.js"></script>
        <script>
                !function ($) {
