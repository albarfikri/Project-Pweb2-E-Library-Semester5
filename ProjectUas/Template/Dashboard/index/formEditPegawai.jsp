<%-- 
    Document   : formEditPegawai
    Created on : Jan 2, 2020, 2:19:34 PM
...
<jsp:useBean id="pegawaidatabase" class="OlahData.pegawaidatabase"/>
<jsp:useBean id="pegawai" class="OlahData.pegawai"/>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%
    int id = Integer.parseInt(request.getParameter("id"));
    pegawai = pegawaidatabase.getPegawaiById(id);
    String username = pegawai.getUsername();
    String password = pegawai.getPassword();
    String peran = pegawai.getPeran();
    String nama = pegawai.getNama();
    String alamat = pegawai.getAlamat();
    String no = pegawai.getNo();
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="OlahUpdatePegawai.jsp" method="POST">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="col">
                                        ...
                                        <select name="peran" class="form-control">
                                            <option value="<%=peran%>">Admin</option>
                                            <option value="member">Member</option>
                                        </select>
                                        <%} else{
                                        %>
                                        <select name="peran" class="form-control">
                                            <option value="<%=peran%>">Member</option> 
                                ...
                                <div class="form-group col-md-6">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" value="<%=no%>"  name="no_telp">
                                    </div>  
                                </div>
