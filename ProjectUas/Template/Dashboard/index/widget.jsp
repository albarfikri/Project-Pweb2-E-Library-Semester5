    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/index/widget.jsp"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg> Widgets</a></li>
        ...
        <script src="http://localhost:8080/assets/js/bootstrap-table.js"></script>
        <script>
            $('#calendar').datepicker({
            });
